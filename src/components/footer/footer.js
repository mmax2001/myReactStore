                ...
                <section className="p-3 pt-0">
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-5 col-lg-4 ml-lg-0 textCenter textMdEnd">
                            {/* <!-- Telegram --> */}
                            <a href="www.telegram.com" className="btn btnOutlineLight btnFloating m-1" class="text-white" aria-label="telegram" role="button">
                                <FaTelegram style={{fontSize:"30px",marginRight:"25px"}}/>
                            </a>
                            {/* <!-- Whatsapp --> */}
                            <a href="www.whatsapp.com" className="btn btn-outline-light btn-floating m-1" class="text-white" aria-label="whatsapp" role="button">
                                <BsWhatsapp style={{fontSize:"30px",marginRight:"25px"}}/>
                            </a>
                            {/* <!-- Facebook --> */}
                            <a href="www.facebook.com" className="btn btn-outline-light btn-floating m-1" class="text-white" aria-label="facebook" role="button">
                                <BsFacebook style={{fontSize:"30px",marginRight:"25px"}}/>
                            </a>
                            {/* <!-- Instagram --> */}
                            <a href="www.instagram.com" className="btn btn-outline-light btn-floating m-1" class="text-white" aria-label="instagram" role="button">
